...
/**
 * Represents the proxy configuration that is retrieved from the Jenkins
 * settings.
 * This information is populated from the Plugin Manager's Advanced section.
 * Because of the Jenkins.get() used in the constructor, you can only create it
 * on the master, not on an agent.
 */
