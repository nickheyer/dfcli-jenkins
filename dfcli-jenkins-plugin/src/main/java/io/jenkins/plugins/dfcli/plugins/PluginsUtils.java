package io.jenkins.plugins.dfcli.plugins;
...
public class PluginsUtils {
    ...
    public static StringCredentials accessTokenCredentialsLookup(String credentialsId, Item item) {
        return CredentialsMatchers.firstOrNull(
                lookupCredentials(StringCredentials.class, item), CredentialsMatchers.withId(credentialsId));
    }
        ...
        if (accessCred != null) {
            ...
            if (usernamePasswordCredentials != null) {
                return new Credentials(
                        Secret.fromString(usernamePasswordCredentials.getUsername()),
                        usernamePasswordCredentials.getPassword(),
                        Credentials.EMPTY_SECRET);
            }
